...
function UnitCard({ item }: { item: LearnItem }) {
  const href =
    item.type === "unit"
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="rounded-[30px] border border-red-400/20 bg-red-400/10 p-8">
            ...
            <p className="mt-3 text-sm text-red-100">
              {error || "Unable to load this module."}
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-6xl px-4 py-6 md:px-6 xl:px-8">
              ...
              {item.imageUrl ? (
                ...
                <div className="flex h-full min-h-[320px] items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-lg font-medium">Module</p>
                    <p className="mt-2 text-sm text-zinc-400">
                      Internal CreatorGoat learning view
                    </p>
                  </div>
                </div>
              )}
        ...
        <section className="mt-8">
          <div className="mb-4 flex items-center justify-between">
            <h2 className="text-2xl font-semibold">Units & lessons</h2>
