    ...
    <div className="min-h-screen bg-black p-6 text-white">
      ...
      <div className="rounded-3xl border border-yellow-500/20 bg-zinc-950 p-8">
        ...
        <p className="mt-4 max-w-5xl text-lg leading-8 text-zinc-400">
          View, search, filter, and copy your saved AI outputs from Creator Brain,
          Auto Viral, Trend Scanner, Product Discovery, and Video Cloning.
        </p>
      </div>
      ...
      <div className="mt-6 rounded-3xl border border-yellow-500/20 bg-zinc-950 p-6">
        ...
        <div className="mt-4 rounded-full border border-zinc-800 px-4 py-2 text-sm text-zinc-400 inline-flex">
          {itemCountText}
        </div>
      </div>
        ...
        {loading ? (
          ...
          <div className="rounded-3xl border border-dashed border-zinc-800 bg-zinc-950 p-10 text-center">
            ...
            <p className="mt-3 text-zinc-500">
              Saved AI outputs will appear here once you start storing results.
            </p>
          </div>
        ) : (
                  ...
                  <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
                    ...
                    <div className="flex shrink-0 flex-wrap gap-3 xl:w-[220px] xl:flex-col">
                      <button
                        ...
                        className="inline-flex items-center justify-center gap-2 rounded-xl bg-yellow-400 px-4 py-3 font-semibold text-black"
                      >
                        <Copy size={14} />
                        Copy Output
                      </button>
                      ...
                      <button
                        ...
                        className="inline-flex items-center justify-center gap-2 rounded-xl border border-zinc-700 px-4 py-3 font-semibold text-white"
                      >
                        <RotateCcw size={14} />
                        Reuse
                      </button>
                      ...
                      <button
                        ...
                        className="inline-flex items-center justify-center gap-2 rounded-xl border border-red-500/30 px-4 py-3 font-semibold text-red-300"
                      >
                        <Trash2 size={14} />
                        Delete
                      </button>
