...
export default function ViralTrendRadarPage() {
  ...
  const statusLabel = useMemo(() => {
    if (scanScore >= 90) return "Explosive"
  ...
  const runRadar = async () => {
    ...
    try {
      ...
      const res = await fetch("/api/viral-trend-radar", {
        method: "POST",
        headers: {
      ...
      const output = data.result || data.error || "No radar report generated."

      setResult(output)

      if (data.result) {
        await saveToHistory({
          module: "Viral Trend Radar",
          title: `${niche || "General"} Viral Trend Radar`,
          input: {
            niche,
            platform,
            goal,
        ...
        <div className="grid gap-6 xl:grid-cols-[1.45fr_0.95fr]">
          <div className="relative overflow-hidden rounded-[32px] border border-yellow-500/20 bg-gradient-to-br from-[#090909] via-black to-[#121212] p-6 md:p-8 xl:p-10 shadow-[0_0_60px_rgba(234,179,8,0.08)]">
            ...
            <p className="mt-4 max-w-3xl text-sm leading-8 text-zinc-400 md:text-base">
              Read momentum before the crowd does. This radar is built to detect
              viral movement, rising content angles, and creator opportunities
              with stronger timing and clearer strategic direction.
            </p>
            ...
            <div className="mt-8 grid gap-4 md:grid-cols-4">
              ...
              <div className="rounded-2xl border border-yellow-500/15 bg-black/60 p-4 backdrop-blur-sm">
                ...
                <p className="mt-3 text-2xl font-bold text-white">{scanScore}%</p>
              </div>
              ...
              <div className="rounded-2xl border border-yellow-500/15 bg-black/60 p-4 backdrop-blur-sm">
                ...
                <p className="mt-3 text-2xl font-bold text-white">Radar</p>
              </div>
            </div>
          </div>
          ...
          <div className="relative overflow-hidden rounded-[32px] border border-yellow-500/20 bg-gradient-to-br from-[#0a0a0a] via-black to-[#101010] p-6 md:p-8 shadow-[0_0_60px_rgba(234,179,8,0.06)]">
            ...
            <div className="relative z-10 flex h-full flex-col justify-between">
              <div className="flex flex-wrap gap-2">
                {["signals", "heat", "angles", "timing"].map((item) => (
                  <span
                    key={item}
              ...
              <div className="rounded-[28px] border border-yellow-500/15 bg-black/65 p-6 backdrop-blur-sm">
                ...
                <p className="mt-4 text-sm leading-8 text-zinc-400">
                  This module is built to identify what is rising, what is
                  getting attention, and what creators should move on next
                  before a trend becomes crowded.
                </p>

                <div className="mt-6 grid gap-3">
                  <div className="flex items-center justify-between rounded-2xl border border-yellow-500/10 bg-zinc-950/80 px-4 py-3">
                    <span className="text-sm text-zinc-400">Trend Heat</span>
                  ...
                  <div className="flex items-center justify-between rounded-2xl border border-yellow-500/10 bg-zinc-950/80 px-4 py-3">
                    <span className="text-sm text-zinc-400">Action Signal</span>
        ...
        <div className="grid gap-8 xl:grid-cols-[500px_minmax(0,1fr)]">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <h2 className="mt-1 text-xl font-bold text-white">
                  Build your radar scan
                </h2>
              </div>
            </div>

            <p className="mt-4 text-sm leading-7 text-zinc-400">
              Enter your niche, platform, and goal to scan for viral momentum,
              content opportunities, and stronger timing signals.
            </p>
            ...
            <div className="mt-7 space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Spot opportunities"
                  className="w-full rounded-2xl border border-yellow-500/20 bg-black px-4 py-4 text-white outline-none transition focus:border-yellow-400/50 focus:shadow-[0_0_0_4px_rgba(250,204,21,0.06)]"
                />
              </div>
          ...
          <div className="space-y-5">
            <div className="grid gap-4 md:grid-cols-4">
              <div className="rounded-2xl border border-yellow-500/15 bg-zinc-950/95 p-4">
                ...
                <p className="mt-2 text-sm text-zinc-400">
                  Read momentum before others do.
                </p>
              </div>
              ...
              <div className="rounded-2xl border border-yellow-500/15 bg-zinc-950/95 p-4">
                ...
                <p className="mt-2 text-sm text-zinc-400">
                  Find stronger creative directions.
                </p>
              </div>
              ...
              <div className="rounded-2xl border border-yellow-500/15 bg-zinc-950/95 p-4">
                ...
                <p className="mt-2 text-sm text-zinc-400">
                  Move when the window is opening.
                </p>
              </div>
              ...
              <div className="rounded-2xl border border-yellow-500/15 bg-zinc-950/95 p-4">
                ...
                <p className="mt-2 text-sm text-zinc-400">
                  Turn signals into content moves.
                </p>
              </div>
            </div>
            ...
            <div className="rounded-[28px] border border-yellow-500/20 bg-zinc-950/95 p-6 shadow-[0_0_40px_rgba(234,179,8,0.06)]">
              ...
              <div className="relative min-h-[700px] overflow-hidden rounded-[24px] border border-yellow-500/10 bg-black">
                ...
                {result ? (
                  <div className="relative z-10 h-full p-5 md:p-6">
                    <div className="mb-5 flex items-center gap-2 text-xs uppercase tracking-[0.24em] text-yellow-500/70">
                      ...
                      Generated Viral Trend Intelligence
                    </div>
                  ...
                  <div className="relative z-10 flex min-h-[700px] flex-col items-center justify-center px-6 text-center">
                    ...
                    <h3 className="text-2xl font-bold text-yellow-400">
                      Radar results will appear here
                    </h3>

                    <p className="mt-4 max-w-xl text-sm leading-8 text-zinc-500">
                      Run a scan to generate premium trend intelligence with
                      heat signals, viral angles, rising topics, and the best
                      next move for the creator.
                    </p>
                    ...
                    <div className="mt-8 grid w-full max-w-3xl gap-3 md:grid-cols-3">
                      <div className="rounded-2xl border border-yellow-500/10 bg-zinc-950/80 p-4 text-left">
                        ...
                        <p className="mt-2 text-sm text-zinc-400">
                          See which signals are warming up.
                        </p>
                      </div>
                      ...
                      <div className="rounded-2xl border border-yellow-500/10 bg-zinc-950/80 p-4 text-left">
                        ...
                        <p className="mt-2 text-sm text-zinc-400">
                          Detect directions you can create from.
                        </p>
                      </div>
                      ...
                      <div className="rounded-2xl border border-yellow-500/10 bg-zinc-950/80 p-4 text-left">
                        ...
                        <p className="mt-2 text-sm text-zinc-400">
                          Get a sharper action recommendation.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="mt-5 grid gap-4 md:grid-cols-3">
                <div className="rounded-2xl border border-yellow-500/15 bg-black/70 p-4">
                  ...
                  <p className="mt-2 text-sm text-zinc-400">
                    Reads movement earlier and cleaner.
                  </p>
                </div>
                ...
                <div className="rounded-2xl border border-yellow-500/15 bg-black/70 p-4">
                  ...
                  <p className="mt-2 text-sm text-zinc-400">
                    Gives better direction for what to create.
                  </p>
                </div>
                ...
                <div className="rounded-2xl border border-yellow-500/15 bg-black/70 p-4">
                  ...
                  <p className="mt-2 text-sm text-zinc-400">
                    Helps avoid moving too late on trends.
                  </p>
                </div>
              </div>
            </div>
