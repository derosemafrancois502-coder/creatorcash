...
function GrowthEngineVisual() {
  return (
    <div className="relative flex h-[340px] w-full items-center justify-center overflow-hidden rounded-[32px] border border-yellow-500/20 bg-[radial-gradient(circle_at_center,rgba(250,204,21,0.08),transparent_48%),linear-gradient(180deg,rgba(10,10,10,0.98),rgba(18,18,18,0.98))]">
      ...
      <div className="absolute right-[10%] top-[24%] rounded-full border border-amber-400/20 bg-amber-500/10 px-4 py-2 text-xs text-amber-200/90 shadow-[0_0_30px_rgba(250,204,21,0.12)] rotate-[8deg]">
        strategy
      </div>
      ...
      <div className="relative flex items-end gap-3">
        <div className="h-20 w-12 rounded-t-2xl bg-gradient-to-t from-yellow-700 via-yellow-500 to-yellow-300 shadow-[0_0_20px_rgba(250,204,21,0.20)]" />
        <div className="h-32 w-12 rounded-t-2xl bg-gradient-to-t from-amber-700 via-yellow-500 to-amber-300 shadow-[0_0_24px_rgba(250,204,21,0.24)]" />
        <div className="h-44 w-12 rounded-t-2xl bg-gradient-to-t from-orange-700 via-yellow-500 to-yellow-300 shadow-[0_0_28px_rgba(250,204,21,0.28)]" />
        <div className="h-56 w-12 rounded-t-2xl bg-gradient-to-t from-yellow-800 via-yellow-500 to-white/80 shadow-[0_0_32px_rgba(250,204,21,0.30)]" />
      </div>
      ...
      <div className="absolute bottom-6 left-6 right-6">
        <div className="rounded-2xl border border-yellow-500/20 bg-black/35 p-4 backdrop-blur-sm">
          <p className="text-xs uppercase tracking-[0.22em] text-yellow-300/70">
            Growth Intelligence Core
          </p>
          <p className="mt-2 text-sm text-zinc-300">
            Premium growth engine for strategy, scale, audience expansion, and stronger creator momentum.
          </p>
        </div>
      </div>
    </div>
...
export default function GrowthPage() {
  ...
  async function handleGenerate() {
    try {
      ...
      setResult("Failed to generate growth ideas.")
    } finally {
      setLoading(false)
    }
  }
        ...
        <div className="grid gap-8 xl:grid-cols-[1.15fr_0.85fr] xl:items-center">
          <div>
            ...
            <p className="mt-4 max-w-2xl text-base leading-7 text-zinc-400">
              Generate premium growth strategies that help creators scale audience,
              improve reach, and build stronger momentum across platforms.
            </p>

            <div className="mt-6 grid gap-4 sm:grid-cols-3">
              <StatCard label="Mode" value="Premium" />
              <StatCard label="Output" value={`${resultCount}`} />
              <StatCard label="Focus" value="Scale" />
            </div>
          </div>
          ...
          <div className="space-y-5">
            <div>
              ...
              <input
                ...
                placeholder="Luxury mindset content"
            ...
            <div className="rounded-2xl border border-yellow-500/15 bg-yellow-500/5 p-4 text-sm text-zinc-300">
              This module is built for creator growth strategy, audience expansion,
              luxury content positioning, traffic growth, and premium scaling ideas.
            </div>
            ...
            >
              {loading ? "Generating..." : "Generate Growth Ideas"}
            </button>
          </div>
        </div>
        ...
        <div className="rounded-[30px] border border-yellow-500/20 bg-zinc-950 p-6 shadow-[0_0_40px_rgba(250,204,21,0.05)]">
          ...
          <div className="mt-5 rounded-3xl border border-zinc-800 bg-black/30 p-5">
            <pre className="min-h-[420px] whitespace-pre-wrap text-sm leading-7 text-zinc-300">
              {result ||
                "Your growth ideas will appear here. Generate premium strategy ideas for your content, creator brand, offers, audience growth, and long-term scaling."}
            </pre>
          </div>
